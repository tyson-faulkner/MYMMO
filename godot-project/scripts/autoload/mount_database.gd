...
# Full art brief and build order: docs/kingsmourn-mount-spec.md.
#
...
const DEFINITIONS := {
	&"mount_scrap_chopper":
	{
		...
		"speed": 1.5,
		"source": "Odda Vane, Thornhollow Vale — for Sovereigns",
		"required_level": 10,
		"value": 900,
	...
	&"mount_veil_saber":
	{
		...
		"speed": 1.6,
		"source": "The First King — Barrow of the First King",
		"required_level": 10,
		"value": 0,
	...
	&"mount_marcher_bear":
	{
		...
		"speed": 1.6,
		"source": "Sablemarch quest chain, final reward",
		"required_level": 14,
		"value": 0,
	...
	&"mount_risen_brute":
	{
		...
		"speed": 1.65,
		"source": "The Weight of Them — The Drowned Redoubt",
		"required_level": 14,
		"value": 0,
	...
	&"mount_wraithcat":
	{
		...
		"speed": 1.7,
		"source": "The Bound Ledger — The Hall of Records",
		"required_level": 18,
		"value": 0,
	...
	&"mount_foundry_walker":
	{
		...
		"speed": 1.7,
		"source": "Gudrun, Kingsmourn — very expensive",
		"required_level": 18,
		"value": 6000,
	...
	&"mount_tombthrone":
	{
		...
		"speed": 1.7,
		"source": "Kingsmourn quest chain, final reward",
		"required_level": 19,
		"value": 0,
	...
	&"mount_twin_furnace_hound":
	{
		...
		"speed": 1.75,
		"source": "The Throne of Kingsmourn — raid",
		"required_level": 20,
		"value": 0,
