...
- **Surprising:** "Kingsguard" appears nowhere in the repo, so that line of the mapping had nothing to do. The First King's enrage mechanic is now "The King's Mourning" and the season-one title "Mournbound" (both renamed on request after the pass, so nothing collides with the city). Left alone as ambiguous: the ability "Chill of the Barrow", and the mob names "Barrow Wight" and "Barrow Guardian" (barrow the noun).
