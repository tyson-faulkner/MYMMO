...
- **Surprising:** "Kingsguard" appears nowhere in the repo, so that line of the mapping had nothing to do. The First King's enrage mechanic is now "Ironhold" too (renamed on request after the pass). Left alone as ambiguous: the season title "Kingsmourner", the ability "Chill of the Barrow", and the mob names "Barrow Wight" and "Barrow Guardian" (barrow the noun).
