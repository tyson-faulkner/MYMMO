...
| | Content | Levels |
|---|---|---|
| Zone 1 | **Thornfell** | 1 – 8 |
| Dungeon 1 | **The Deepbarrow** | 8 |
| Zone 2 | **Greymarch** | 8 – 14 |
| Dungeon 2 | **The Drowned Hold** | 14 |
| Zone 3 | **Ironhold** | 14 – 20 |
| Dungeon 3 | **The Archive** | 18 |
| Raid | **The Broken Throne** | 20 |
...
**Ends with:** the Drowned Hold, a siege fort in flooded ground where both
...
**Ends with:** the the Archive at 18, and the Throne at 20.

---

## The dungeons

### 1. The Deepbarrow — level 8
...
### Raid — The Broken Throne — level 20
...
1. **Re-band the existing content.** The twelve Thornfell quests currently
...
3. **Two more zone scenes**, both built from `ZoneBuilder` the same way. Greymarch
   needs new terrain art — burnt ground, ruins, trenches, flood. Ironhold needs
   almost none: it is the kit you already have, denser, plus a palace.

4. **Roughly 22 more quests** — ten for Greymarch, twelve for Ironhold.

5. **New enemies, all on the shared body:** house infantry variants for the
   front, drowned dead for the Hold, city guard and house retainers for the
   capital. Only the raid needs anything genuinely new.

## Build order

Finish Thornfell first. A zone that is actually good, all the way through, is
worth more than three that are half-built — and everything the second and third
zones need is proven by finishing the first.

1. Re-band Thornfell and the Barrow to 1-8.
2. Wire the class and enemy models in. Get it *looking* finished.
3. Greymarch: layout, enemies, ten quests.
4. The Drowned Hold.
5. Ironhold: layout, twelve quests.
6. The Archive.
7. The Broken Throne, then its heroic version and the mount.
